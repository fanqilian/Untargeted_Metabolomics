...
def Run_Second_code(mzXML_file_path):
    ...
    os.system(Run_cmd)
    Run_cmd_v2 = Rscript_work_path + ' /home/zhangpeng/Project/TCM_PEP/Tools/filter_table_third_v2.R ' + mzXML_file_path
    os.system(Run_cmd_v2)



mzXML_file_path = '/Media/E/zhangpeng/Urea_Serum/Urea/POS/'
mzXML_file_path = '/Media/E/zhangpeng/Urea_Serum_two/UREA_NEG/'
Create_Bin_ID(mzXML_file_path)
Run_Second_code(mzXML_file_path)

mzXML_file_path = '/Media/E/zhangpeng/Urea_Serum_two/UREA_POS/'
Create_Bin_ID(mzXML_file_path)
Run_Second_code(mzXML_file_path)
